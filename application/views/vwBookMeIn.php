        ...
        <div id="panel4">
            ...
            <div class="rightSide">					
                ...
                <form id="formPaypal" action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_blank">						
                    ...
                    <input type="image"  id="btnPay" src="https://www.paypal.com/es_XC/i/btn/btn_xpressCheckout.gif" border="0" name="submit" alt="Make payments with PayPal - it's fast, free and secure!" width="300" height="220">

...
$(function() {
    ...
    $("#btnSiguiente2").click(function() {
        if (validateSelect() === true) {
            ...
            $(".alert").text("Debes seleccionar al menos un cuarto");
            $(".alert").show("slow");
        }
    });
    ...
    $("#btnAnterior, #btnAnterior4").click(function() {
        $(".alert").hide();
        SLIDER.prev();
    });
...
function validateCustomerInfo() {
    if ($("#cName").val() === '' ||
            ...
            $("#cPhone").val() === '' ||
            $("#cEmail").val() === '') {
        $(".alert").text("Todos los campos son obligatorios");
        $(".alert").show("slow");
        return false;
    }
    if (!validateEmail($("#cEmail").val())) {
        $(".alert").hide();
        $(".alert").text("Correo no valido");
        $(".alert").show("slow");
        return false;
    }
    return true;
...
function generateReserve() {
    ...
    if (reserved === 0) {
        ...
        $(".alert").text("Generando Reservacion...");
        $(".alert").show("slow");

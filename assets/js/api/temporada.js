		...
		$.ajax({
			...
			success: function(data){
                if (typeof data.error != "undefined"){
                    $("#inDate").html("Las fechas coinciden con la temporada: "+data.data.nombre+"<br/> ("+data.data.fechaInicio+" - "+data.data.fechaFin+")");
                    $("#inDate").show("slow");
                }else{
                    // Save prices
